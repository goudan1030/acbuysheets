    ...
    <div className="bg-[#D6FFF1] h-[320px]">
      <div className="px-20 h-full">
        <div className="flex flex-col items-center h-full">
          {/* 顶部标题 */}
          <h2 className="text-[36px] font-bold text-black pt-8">
            over 2000+
          </h2>

          {/* 黑色背景区域 */}
          <div className="w-[820px] h-[432px] bg-black mt-4 rounded-[20px] flex flex-col items-center pt-12 pb-8">
            {/* 主标题 */}
            ...
            {/* 标签 */}
            <span className="text-[36px] font-bold text-[#D6FFF1] mt-0.5">
              WITH QC PHOTOS
            </span>

            {/* 描述文字 */}
            <p className="text-[20px] text-white mt-1 leading-relaxed text-center w-full px-[30px]">
